...
var configAgendaController_exports = {};
__export(configAgendaController_exports, {
  configAgendaController: () => configAgendaController
});
module.exports = __toCommonJS(configAgendaController_exports);
